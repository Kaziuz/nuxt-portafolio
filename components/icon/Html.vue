...
<template>
  <svg :fill="fill" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    :width="size" :height="size" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve">
